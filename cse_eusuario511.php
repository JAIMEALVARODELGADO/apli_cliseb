...
conectarbd();
$consulta=mysql_query("select iden_ucs,nomb_ucs,logi_ucs,clav_ucs,tipo_ucs
                          from u_cliseb where codi_ucs=$codi_ucs");
...
<table class='Tbl0' width='100%' border='0'>
  <tr>
	...
	<td class='Td2' width='30%' align='left'><input type='text' name='iden_ucs' size='20' maxlength='20' value='<?echo $row[iden_ucs];?>'></td>
  </tr>
  <tr>
	<td class='Td2' width='20%' align='right'>Nombre y Apellido:</td>
    <td class='Td2' width='30%' align='left'><input type='text' name='nomb_ucs' size='50' maxlength='50' value='<?echo $row[nomb_ucs];?>'></td>
  </tr>
  <tr>
    <td class='Td2' align='right'>Login:</td>
    <td class='Td2' align='left'><input type='text' name='logi_ucs' size='40' maxlength='40' value='<?echo $row[logi_ucs];?>'></td>
  </tr>
  <tr>
...
<input type='hidden' name='codi_ucs' value='<?echo $codi_ucs?>'>
<script language='javascript'>
document.form1.tipo_ucs.value='<?echo $row[tipo_ucs];?>';
</script>
<br>
