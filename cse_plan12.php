...
<br>
<?
$consultapre=mysql_query("SELECT codi_pre,desc_pre FROM premio WHERE codi_pre=$codi_pre");
$rowpre=mysql_fetch_array($consultapre);
?>
<table class='Tb0' width='60%' border='0'>
  ...
  <tr>
	...
	<td class='Td2'></td>
	<td class='Td2'></td>
	<td class='Td2'><input type='text' name='desc_pre' size='50' maxlength='50' value='<?echo $rowpre[desc_pre];?>'></td>
  </tr>
</table>
<input type='hidden' name='codi_pre' value='<?echo $rowpre[codi_pre];?>'>
<br>
<table class='Tbl0'>
  <tr>
